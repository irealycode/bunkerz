    ...
    if(jid){
        ...
        <div >
            <div className="webview" style={{position:'absolute',height:height,width:360,backgroundColor:'white',left:0,alignItems:'center',justifyContent:'center',textAlign:'center',flexDirection:'column',borderRight:'2px solid black',zIndex:2,overflowX:'hidden',overflowY:'scroll'}} >
                    ...
                    <h1 style={{fontFamily:'ns',fontSize:22}} >online store</h1>
                    <h1 onClick={()=>setSide(!side)} style={{position:'absolute',fontFamily:'ns',fontSize:22,top:0,right:10}} >+</h1>
...

                    {
                        Banners.map((bn,yy)=>{
                            ...
                            return (
                                ...
                                <div ref={ref2.current.clientHeight[bn.id]} style={{position:'absolute',top:50,width:'100%',alignItems:'center',justifyContent:'center',alignSelf:'center',display:'flex',flexDirection:'column'}} >
                                ...
                                <div style={{marginTop:0,display:'flex',flexDirection:'row',width:'100%',justifyContent:'flex-start',alignItems:'center',marginLeft:70,marginBottom:5}} >
                                    ...
                                    <button onClick={async()=>{setBannerDivs(bannerDivs=>[...bannerDivs,{parent:bn.id,id:bannerDivs.length,marginH:0,align:'center',show:true,fdirection:'column'}]);await update();}} style={{border:'2px solid black',width:'90%',padding:5,color:'black',fontFamily:'monospace',fontWeight:'bolder',fontSize:15,backgroundColor:'white',borderRadius:5}} >
                                        add div
                                    </button>
                                </div>
                            </div>
                            ...
                            return (
                            <div className="bannerEdit" style={{position:'relative',marginLeft:0,height:bn.show?ref2.current.clientHeight[bn.id].current.clientHeight+40:10,overflow:'scroll',overflowX:'hidden',width:'100%',alignItems:'center',justifyContent:'center',alignSelf:'center',display:'flex',flexDirection:'column',borderBottom:yy == Banners.length-1?'2px solid black':'0px',borderTop:'2px solid black',paddingBottom:10,paddingTop:10}} >
                    ...
                    <button onClick={()=>setNewB({...newB,show:true})} style={{border:'2px solid black',marginTop:10,width:'90%',padding:5,color:'black',fontFamily:'monospace',fontWeight:'bolder',fontSize:15,backgroundColor:'white',borderRadius:5}} >
                        add banner
                    </button>
            ...
            <div style={{position:'absolute',width:width-360,height:height,right:0,overflow:'scroll',overflowX:'hidden'}} >
                <DefaultT width={width-460} height={height} banners={Banners} bannerTexts={bannerTexts} bannerImgs={bannerImgs} bannerDivs={bannerDivs} bannerProducts={products} storeProducts={storeProducts}   />
                {/* <ProductT width={width-360} height={height} banners={[Banners[0]?Banners[0]:{}]} bannerTexts={bannerTexts} bannerImgs={bannerImgs} bannerDivs={bannerDivs} product={products[0]}  /> */}
                        ...
                        <div className="text" style={{overflow:'scroll',position:'absolute',alignSelf:'center',backgroundColor:'white',borderRadius:5,width:'100%',maxHeight:!page?0:200,border:!page?0:2+'px solid black',borderRadius:5,bottom:0}} >
                            {
                                pages.map((pageName,i)=>{
                                    return(
                                        <p onClick={()=>setPagen(pageName)} style={{fontFamily:'monospace',fontWeight:'bolder',fontSize:15,margin:0,padding:6}} >{pageName}</p>
                                    )
                                })
                            }
