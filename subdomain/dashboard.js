  ...
  return (
        <div style={{height:'100%',width:'100%'}} >
            <div style={{height:70,width:'100%',flexDirection:'row',display:'flex'}} >
                <div style={{height:'100%',width:330,backgroundColor:'#FF9900'}} >
                    <img src={logo} alt="" style={{height:60,width:120,marginLeft:30}} />
                </div>
            ...
            <div style={{width:'100%',height:height-70,backgroundColor:'#F6F3EF',display:'flex',flexDirection:'row'}} >
                <div style={{width:328,height:'100%',backgroundColor:'#F6F3EF',borderRight:'2px solid #CAC2B6',position:'relative'}} >
                    <div style={{marginTop:25}} >
                        <button  onClick={()=>SetTab(0)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8}} >
                            <img src={tab == 0?homeC:home} style={{height:30,width:30,filter:tab!=0?'invert(20%)':'invert(0%)',marginLeft:35}} />
                            <h1 onMouseOver={()=>SetHover(0)} onMouseOut={()=>SetHover(tab)} style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=0 && hover!=0?'rgba(0,0,0,0.8)':'#ff9900'}} >Home</h1>
                        </button>
                        <button  onClick={()=>SetTab(1)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8}} >
                            <img src={tab == 1?ordersC:orders} style={{height:30,width:30,filter:tab!=1?'invert(20%)':'invert(0%)',marginLeft:35}} />
                            <h1 onMouseOver={()=>SetHover(1)} onMouseOut={()=>SetHover(tab)} style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=1 && hover!=1?'rgba(0,0,0,0.8)':'#ff9900'}} >Orders</h1>
                        </button>
                        <button  onClick={()=>SetTab(2)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8}} >
                            <img src={tab == 2?productsC:products} style={{height:30,width:30,filter:tab!=2?'invert(20%)':'invert(0%)',marginLeft:35}} />
                            <h1 onMouseOver={()=>SetHover(2)} onMouseOut={()=>SetHover(tab)} style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=2 && hover!=2?'rgba(0,0,0,0.8)':'#ff9900'}} >Products</h1>
                        </button>
                        <button  onClick={()=>SetTab(3)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8}} >
                            <img src={tab == 3?customersC:customers} style={{height:30,width:30,filter:tab!=3?'invert(20%)':'invert(0%)',marginLeft:35}} />
                            <h1 onMouseOver={()=>SetHover(3)} onMouseOut={()=>SetHover(tab)} style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=3 && hover!=3?'rgba(0,0,0,0.8)':'#ff9900'}} >Customers</h1>
                        </button>
                        <button  onClick={()=>SetTab(4)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8}} >
                            <img src={tab == 4?analyticsC:analytics} style={{height:30,width:30,filter:tab!=4?'invert(20%)':'invert(0%)',marginLeft:35}} />
                            <h1 onMouseOver={()=>SetHover(4)} onMouseOut={()=>SetHover(tab)} style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=4 && hover!=4?'rgba(0,0,0,0.8)':'#ff9900'}} >Analytics</h1>
                        </button>
                        <button  onClick={()=>SetTab(5)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8}} >
                            <img src={tab == 5?marketingC:marketing} style={{height:30,width:30,filter:tab!=5?'invert(20%)':'invert(0%)',marginLeft:35}} />
                            <h1 onMouseOver={()=>SetHover(5)} onMouseOut={()=>SetHover(tab)} style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=5 && hover!=5?'rgba(0,0,0,0.8)':'#ff9900'}} >Marketing</h1>
                        </button>
                        <button  onClick={()=>SetTab(6)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8}} >
                            <img src={tab == 6?templatesC:templates} style={{height:30,width:30,filter:tab!=6?'invert(20%)':'invert(0%)',marginLeft:35}} />
                            <h1 onMouseOver={()=>SetHover(6)} onMouseOut={()=>SetHover(tab)} style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=6 && hover!=6?'rgba(0,0,0,0.8)':'#ff9900'}} >Templates</h1>
                        </button>
                    </div>
                    <button onMouseOver={()=>SetHover(7)} onMouseOut={()=>SetHover(tab)} onClick={()=>SetTab(7)} style={{height:45,backgroundColor:'rgba(0,0,0,0)',border:0,width:'100%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'start',marginTop:8,position:'absolute',bottom:20}} >
                        <img src={tab == 7?settingsC:settings} style={{height:30,width:30,filter:tab!=7?'invert(20%)':'invert(0%)',marginLeft:35}} />
                        <h1 style={{fontSize:20,marginBottom:5,fontFamily:'ml',marginLeft:20,color:tab!=7 && hover!=7?'rgba(0,0,0,0.8)':'#ff9900'}} >Settings</h1>
                    </button>
                </div>
                <div style={{width:width-330,height:'100%'}} >
                    {tab ==0?<Home/>:null}
                    {tab == 2?<Products/>:null}
                </div>
            </div>
